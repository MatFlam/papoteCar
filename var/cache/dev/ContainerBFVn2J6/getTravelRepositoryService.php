...
// Returns the private 'App\Repository\TravelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TravelRepository.php';

return $this->privates['App\Repository\TravelRepository'] = new \App\Repository\TravelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
