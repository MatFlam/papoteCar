...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AlertRepository' => function () {
    return ($this->privates['App\Repository\AlertRepository'] ?? $this->load('getAlertRepositoryService.php'));
}, 'App\\Repository\\CarRepository' => function () {
...
}, 'App\\Repository\\PaymentRepository' => function () {
    return ($this->privates['App\Repository\PaymentRepository'] ?? $this->load('getPaymentRepositoryService.php'));
}, 'App\\Repository\\PrivateMessagesRepository' => function () {
    return ($this->privates['App\Repository\PrivateMessagesRepository'] ?? $this->load('getPrivateMessagesRepositoryService.php'));
...
}, 'App\\Repository\\TravelRepository' => function () {
    return ($this->privates['App\Repository\TravelRepository'] ?? $this->load('getTravelRepositoryService.php'));
