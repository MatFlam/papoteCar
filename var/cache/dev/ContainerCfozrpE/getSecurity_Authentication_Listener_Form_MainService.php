...
$c->setOptions(array('login_path' => 'login', 'default_target_path' => 'home', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
